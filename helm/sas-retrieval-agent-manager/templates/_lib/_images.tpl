...
{{/* ========== retrieval-agent-manager-evaluation ========== */}}
...
{{/* ========== retrieval-agent-manager-plugin ========== */}}
...
{{/* ========== retrieval-agent-manager-vectorization-hub ========== */}}
...
{{- define "images.vectorizationHub" -}}
  {{- include "images.retrieval-agent-manager-vectorization-hub.repo.base" . -}}/{{- include "images.retrieval-agent-manager-vectorization-hub.repo.path" . -}}:{{- include "images.retrieval-agent-manager-vectorization-hub.tag" . -}}
{{- end }}
